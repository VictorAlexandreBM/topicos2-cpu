...
public record CpuTrayDetailDTO(
        ...
        ModeloCpuDetailDTO modelo, String loteFabricacao, String imagemUrl, String tipo
    ...
    public CpuTrayDetailDTO(CpuTray t) {
        this(t.getId(), t.getSku(), t.getPreco(), t.getEstoque(),
                ...
                new ModeloCpuDetailDTO(t.getModelo()), t.getLoteFabricacao(), t.getImagemUrl(), "TRAY");
    }
